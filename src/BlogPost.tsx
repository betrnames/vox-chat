        ...
        <div className="max-w-3xl mx-auto">
          ...
          <header className="mb-10">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <a
                href={`https://x.com/intent/tweet?text=${encodeURIComponent(post.title)}&url=${encodeURIComponent(`https://vox.chat/blog/${post.slug}`)}&via=voxdotchat`}
                target="_blank"
                rel="noopener noreferrer"
                className="shrink-0 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-border/60 text-muted-foreground/60 hover:text-foreground hover:border-border transition-colors text-xs font-medium"
              >
