...
function VoiceDemo() {
  const messages = [
    ...
    { from: 'ai' as const, text: "5 techs — that's roughly 15 missed calls a week after hours. At $500 average and a 50% close rate, you're leaving about $3,750 a week on the table. Vox Voice fixes that for $595/mo — pays for itself day one." },
    ...
    <section className="py-24 sm:py-32 px-5">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mt-10">
          <a
            href="/roi.html"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg border border-primary/30 text-sm font-medium text-primary hover:bg-primary/5 transition-colors"
          >
            Calculate your ROI
...
export default function App() {
  ...
  return (
    <VapiVoiceProvider>
      ...
      <Footer activePage="home" homePadding />
