...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        type: 'faq',
        questions: [
          { q: 'How much does AI automation cost for a small contractor in the Central Valley?', a: 'Individual systems range from $550/month (receptionist) to $995/month (voice agent). A full bundle of all three systems — voice, chat, and reviews — typically runs $1,500–$2,800/month. At Vox.chat, the complete bundle is $1,500/month with no contracts. That\'s less than a part-time receptionist and available 24/7.' },
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        type: 'faq',
        questions: [
          { q: 'How much does an AI phone agent cost for a Modesto HVAC company?', a: 'AI phone agents for HVAC companies in Modesto typically cost $800–$1,500 per month with no long-term contracts. At Vox.chat, the voice agent is $995/month. Most Modesto HVAC companies recover the full monthly cost within the first week through previously missed calls that are now answered and booked.' },
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        type: 'faq',
        questions: [
          { q: 'How much does an AI phone agent cost for a Modesto roofing company?', a: 'AI phone agents for roofing companies cost $800–$1,500 per month with no long-term contracts. At Vox.chat, the voice agent is $995/month. During storm season, a single answered call that leads to an insurance claim roof replacement ($8,000–$18,000) pays for 6–12 months of the service.' },
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        type: 'faq',
        questions: [
          { q: 'How much does an AI answering service cost for a Turlock contractor?', a: 'AI answering services for Turlock contractors cost $800–$1,500 per month with no long-term contracts. At Vox.chat, the voice agent is $995/month. Most Turlock contractors recover the full monthly cost within the first week through previously missed after-hours calls that are now answered and booked.' },
    ...
    content: [
      ...
      },
      {
        ...
        questions: [
          ...
          { q: 'How much does automated review generation cost?', a: 'Automated review systems for electricians typically cost $300–$500/month. At Vox.chat, the AI Review Agent is $595/month standalone or included in the $1,500/month bundle with voice and chat. Most electricians see 3–5x their review count within 90 days.' },
  ...
  },
  {
    ...
    imageAlt: 'HVAC companies choosing between hiring a receptionist at $38K per year or using AI at $995 per month',
