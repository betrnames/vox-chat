...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        type: 'faq',
        questions: [
          { q: 'How much does an AI answering service cost for a Turlock contractor?', a: 'AI answering services for Turlock contractors cost $800–$1,500 per month with no long-term contracts. At Vox.chat, pricing starts at $1,100/month for the voice agent. Most Turlock contractors recover the full monthly cost within the first week through previously missed after-hours calls that are now answered and booked.' },
    ...
    content: [
      ...
      },
      {
        ...
        questions: [
          ...
          { q: 'How much does automated review generation cost?', a: 'Automated review systems for electricians typically cost $300–$500/month. At Vox.chat, the AI Review Agent is $400/month standalone or included in the $1,500/month bundle with voice and chat. Most electricians see 3–5x their review count within 90 days.' },
  ...
  },
  {
    ...
    imageAlt: 'HVAC companies choosing between hiring a receptionist at $38K per year or using AI at $1,100 per month',
